...
* [2026.05] [**ICML 2026**] [**Multimodal Reasoning**] EARL: Towards a Unified Analysis-Guided Reinforcement Learning Framework for Egocentric Interaction Reasoning and Pixel Grounding [Link](https://arxiv.org/abs/2605.14742) (Supervised undergraduate's final year project).
...
* [2026.02] [**CVPR 2026**] (__CCF-A__) with 3 papers accepted: Hand-Object Interaction Video Synthesis for Embodied Data Augmentation [Link](https://hvg3d.github.io/), Intention-Driven 3D Affordance Grounding for Embodied Perception [Link](https://github.com/RayYoh/Hammer), and Accelerating Diffusion-based Video Editing [Link](https://arxiv.org/abs/2603.24260).
...
* [2025.10] [**NeurIPS 2025**] [LLM Vulnerability] Semantic Representation Attack against Aligned Large Language Models [Link](https://arxiv.org/abs/2509.19360), with [code](https://github.com/JiaweiLian/SRA)
...
* [2025.05] [**Information Fusion**] (IF: 15.5) Contrastive learning-based place descriptor representation for cross-modality place recognition [Link](https://www.sciencedirect.com/science/article/pii/S1566253525004245), with [code](https://github.com/emilyemliyM/Cross-PRNet)
...
* [2025.03] [**CVPR 2025**] [Egocentric Reasoning] ANNEXE: Unified Analyzing, Answering, and Pixel Grounding for Egocentric Interaction [Link](https://arxiv.org/abs/2504.01472), with [code](https://yuggiehk.github.io/annexe/)
* [2025.02] [**ICLR 2025**] [Autonomous Driving Perception] OccProphet: Pushing Efficiency Frontier of Camera-Only 4D Occupancy Forecasting with Observer-Forecaster-Refiner Framework [Link](https://arxiv.org/abs/2410.11075), with [code](https://github.com/JLChen-C/OccProphet)
...
* [2024.11] [**IEEE TCSVT**] (IF: 11.1) SGIFormer: Semantic-guided and Geometric-enhanced Interleaving Transformer for 3D Instance Segmentation [Link](https://ieeexplore.ieee.org/document/10753065), with [code](https://rayyoh.github.io/sgiformer)
* [2024.10] [**IEEE TCSVT**] (IF: 11.1) Open World Object Detection: A Survey [Link](https://ieeexplore.ieee.org/abstract/document/10716705), with [code](https://github.com/ArminLee/OWOD_Review)
* [2024.10] [Outstanding Reviewer](https://2024.acmmm.org/outstanding-ac-reviewer) in ACM Multimedia 2024
* [2024.09] [**Information Fusion**] (IF: 15.5) A survey on occupancy perception for autonomous driving: The information fusion perspective [Link](https://www.sciencedirect.com/science/article/abs/pii/S1566253524004494), with [github link](https://github.com/HuaiyuanXu/3D-Occupancy-Perception)
...
* [2024.02] [**Knowledge-based Systems**] (IF: 7.6) Intra- and Inter-sector Contextual Information Fusion with Joint Self-Attention for File Fragment Classification [Link](https://authors.elsevier.com/c/1iiBw3OAb9CyZK), with [code](https://github.com/WangyiNTU/JSANet)
...
* [2024.01] [**Remote Sensing**] Interactive Change-Aware Transformer Network [Link](https://www.mdpi.com/2072-4292/15/23/5611) for Remote Sensing Image Change Captioning
...
* [2023.09] [**NeurIPS 2023**] Bitstream-corrupted Video Recovery: A Novel Benchmark Dataset and Method [Link](https://arxiv.org/abs/2309.14818), with [dataset](https://github.com/LIUTIGHE/BSCV-Dataset)
